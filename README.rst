...
* The server generates the suitable HTTP response headers which may include
  status codes, content type, cookies, custom headers, etc.
* The server streams the processed output back to the browser, completing the
  request-response cycle.
* The server logs the details of the request and response for the purpose of
  monitoring and debugging, if logging is enabled.
